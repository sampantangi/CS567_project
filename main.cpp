...
int main() {
    ...
    SavingsAccount savings1("SA1234", "Alice", 1000.0, 5.0);
    SavingsAccount savings2("SA5678", "Bob Brown", 1500.0, 3.5);
    CheckingAccount checking1("CA1111", "Charlie", 2000.0, 500.0);
    CheckingAccount checking2("CA2222", "David Brown", 3000.0, 1000.0);
    ...
    cout << "\nTotal Balance in the Bank: $" << bank.getTotalBalance() << endl;

    cout << "\nAccounts held by 'Brown':\n";
    vector<Account*> brownAccounts = bank.findAccountsByHolderName("Brown");
    for (const auto& acc : brownAccounts) {
        acc->displayInfo();
        cout << endl;
    }

    Account* foundAccount = bank.findAccount("CA2222");
    if (foundAccount) {
    ...
    bank.closeAccount("SA1234");

    cout << "\nUpdated Account Details after closure:\n";
    bank.displayAllAccounts();
